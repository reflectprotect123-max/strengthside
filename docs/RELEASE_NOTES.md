...
| Version | Date | Note |
| --- | --- | --- |
| 1.0.58 | 2026-09-05 | Exercise suggest closes on pick (blur + lock; no focus reopen); cache blank-v177 |
| 1.0.57 | 2026-09-05 | Close retired Workout builder; Engine form rebuilt; scrub old builder doors; cache blank-v177 |
