...
| Version | Date | Note |
| --- | --- | --- |
| 1.0.75 | 2026-09-12 | Library Sessions builder + calendar door, rest timer, F1/F2 same-page supersets, silent plan sync (`strength_side`), coach under + only; cache the-brain-v13 |
