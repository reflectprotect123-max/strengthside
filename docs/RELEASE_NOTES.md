...
| Version | Date | Note |
| --- | --- | --- |
| (pending OTA) | 2026-09-08 | Harden builder+logger route: live/optional metrics, painted kg, flatten seeds columns, validate/Open/Close follow live metric; cache blank-v198 |
