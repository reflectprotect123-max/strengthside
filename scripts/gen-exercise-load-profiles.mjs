...
function resolveProfile(ex) {
  ...
  if (mode === 'distance_time_load') return 'carry_distance_time_load';
...
const fixture = {
  ...
  tracking_modes: {
    ...
    distance_time_load: {
      count_in_library: 7,
      description: 'Loaded carries and conditioning — load, distance, duration.',
      default_log_columns: ['weight_kg', 'distance_m', 'time_sec'],
      metrics_per_set: ['load', 'distance', 'duration'],
      metrics_last_set: [],
      default_profile: 'carry_distance_time_load',
    },
    time_or_reps: {
      count_in_library: 4,
  ...
  profiles: {
    ...
    carry_distance_time_load: {
      label: 'Carry — load + distance + time',
      log_columns: ['weight_kg', 'distance_m', 'time_sec'],
      metrics_per_set: ['load', 'distance', 'duration'],
      metrics_last_set: [],
      metrics_progression: ['load', 'distance'],
      progression: 'rep_volume_hint_today',
      note: 'Adapter regex treats carry as rep progression today; fixture uses explicit load metrics.',
    },
  },
  profile_rules: {
    reps_load: [
  ...
  adapter_divergences: [
    ...
    },
    {
      ...
      intended_profile: 'accessory_kg_reps or carry_distance_time_load',
    },
    {
...
(function (global) {
  ...
  global.ExerciseLoadProfiles = { defaultLogColumns };
