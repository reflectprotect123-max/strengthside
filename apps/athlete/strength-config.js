/* Public TRACK origin. Secrets never live here. */
(function (global) {
  global.STRENGTH_CONFIG = {
    ...
    publicOrigin: 'https://orysjncrksmdfabpuftd.supabase.co/functions/v1/strength/',
    functionsProvider: 'supabase',
    hybridProduct: 'strength',
    engineOrigin: './engine/'
  };
})(window);
