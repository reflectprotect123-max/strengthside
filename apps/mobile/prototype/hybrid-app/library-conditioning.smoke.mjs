...
must(sw.includes('the-hybrid-athlete-blank-v192'), 'service worker cache v191');
...
must(html.includes('setEngineLibrarySubTab'), 'Engine analytics sub-tab switch');
must(html.includes('function renderCondAnalytics('), 'renderCondAnalytics');
