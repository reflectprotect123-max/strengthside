...
must(html.includes("LOCAL_BUILD='the-hybrid-athlete-blank-v192'"), 'LOCAL_BUILD v192');
must(sw.includes("const CACHE = 'the-hybrid-athlete-blank-v192'"), 'SW v192');
...
// Strength builder removed after cut
must(!html.includes('function athleteStrengthBuilder'), 'athleteStrengthBuilder removed');
must(!html.includes('function usesAthleteStrengthBuilder'), 'usesAthleteStrengthBuilder removed');
must(!html.includes('function ensureAthleteStrengthDraft'), 'ensureAthleteStrengthDraft removed');
must(!html.includes('function saveStrengthWorkoutAsCopy'), 'saveStrengthWorkoutAsCopy removed');
...
must(html.includes("setLibraryTab('recovery')"), 'Recovery lives in Library tabs');
