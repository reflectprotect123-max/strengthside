...
must(html.includes("LOCAL_BUILD='the-hybrid-athlete-blank-v212'"), 'LOCAL_BUILD v150');
must(sw.includes("const CACHE = 'the-hybrid-athlete-blank-v212'"), 'SW v150');
...
must(html.includes("ATHLETE_BUILDER_VERSION='athlete-builder-v11'"), 'athlete builder migration version');
