...
must(html.includes("LOCAL_BUILD='the-hybrid-athlete-blank-v204'"), 'LOCAL_BUILD v150');
must(sw.includes("const CACHE = 'the-hybrid-athlete-blank-v204'"), 'SW v150');
...
must(html.includes("ATHLETE_BUILDER_VERSION='athlete-builder-v10'"), 'athlete builder migration version');
