...
must(html.includes("LOCAL_BUILD='the-hybrid-athlete-blank-v190'"), 'LOCAL_BUILD v150');
must(sw.includes("const CACHE = 'the-hybrid-athlete-blank-v190'"), 'SW v150');
...
must(html.includes("ATHLETE_BUILDER_VERSION='athlete-builder-v9'"), 'athlete builder migration version');
