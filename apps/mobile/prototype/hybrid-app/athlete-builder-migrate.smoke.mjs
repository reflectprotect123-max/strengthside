...
must(html.includes("ATHLETE_BUILDER_VERSION='athlete-builder-v10'"), 'migration version');
...
must(strengthState.meta.athleteBuilderVersion === 'athlete-builder-v10', 'migration stamp');
