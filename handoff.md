...
| **Capgo** | **`dogfood` + `live` @ `1.0.63`** (strength cut / blank-v191)
...
**Phone:** Settings → Check for updates → expect **1.0.63** (Settings → Check for updates)
...
| Channels | **`dogfood` + `live`** both @ **`1.0.63`** (strength cut OTA)
...
| Capgo | **1.0.63** on `dogfood` + `live` (blank-v191, Engine+Recovery only) |
